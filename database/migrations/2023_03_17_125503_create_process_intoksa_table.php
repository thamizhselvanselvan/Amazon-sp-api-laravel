...
class CreateProcessIntoksaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('shipntracking')->create('process_india_to_ksa', function (Blueprint $table) {
        ...
        DB::connection('shipntracking')->update("ALTER TABLE process_india_to_ksa AUTO_INCREMENT = 1000000000;");
    }
    ...
    {
        Schema::connection('shipntracking')->dropIfExists('process_india_to_ksa');
    }
}
