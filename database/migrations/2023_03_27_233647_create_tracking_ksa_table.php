...
class CreateTrackingKsaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('shipntracking')->create('tracking_ksa', function (Blueprint $table) {
        ...
        DB::connection('shipntracking')->update("ALTER TABLE tracking_ksa AUTO_INCREMENT = 1000000000;");
    }
    ...
    {
        Schema::connection('shipntracking')->dropIfExists('tracking_ksa');
    }
}
