...
class CreateTagStocksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('inventory')->create('tag_stocks', function (Blueprint $table) {
            $table->id();
            $table->string('date');
            $table->string('tag');
    ...
    {
        Schema::connection('inventory')->dropIfExists('tag_stocks');
    }
}
