...
class AmazonFeedProcess
{
    ...
    public function feedSubmit($feedLists, $regionCode, $seller_id, $product_push_id)
    {
        ...
        $feedId = $productFeed;
        $product_query_model->where("id", $product_push_id)->update(['feedback_price_id' => $feedId['feedId']]);
