...
function TrackingDetais($data) {
    ...
    try{
        ...
        if($data === false){
            ...
            $tracking_event_details = $data['PackageTrackingInfo']['TrackingEventHistory']['TrackingEventDetail'];

            if(array_key_exists('EventStatus', $tracking_event_details)) { 

                $eventCity = $tracking_event_details['EventLocation']['City'];
                $eventReason = $tracking_event_details['EventReason'];
                $eventDateTime = $tracking_event_details['EventDateTime'];
                ...
                foreach($tracking_event_details as $key1 => $value1) {
