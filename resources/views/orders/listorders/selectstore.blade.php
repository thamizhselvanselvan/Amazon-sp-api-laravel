...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <h2 class="mb-4">
                <div class="modal fade" id="PushPriceModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.store.update.push.price.column') }}" method="post">
                                ...
                                <div class="modal-body text-sm">
                                    <div class="row">
                                        <div class="col">
                                            <x-adminlte-select name="type" label="Select Type" igroup-size="sm"
                                        ...
                                        <div class="col">
                                            <x-adminlte-input label="value" name="value" type="text"
                                                id="PriceCalculation" />
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button label="Update" theme="success" icon="fas fa-edit"
                                        class="btn btn-sm btn-success">Update</button>
                                    <x-adminlte-button label="Close" theme="danger" icon="fa fa-close"
                                        class="btn btn-sm btn-danger" id="CloseModal" />
                                </div>
                            </form>
                        </div>
                    </div>
