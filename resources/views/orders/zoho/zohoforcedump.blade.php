...
<div class="row">
    ...
    <h2 class="ml-2">
        <x-adminlte-button label=" Zoho operations" class="btn-sm" theme="primary" icon="fa fa-tasks " id="zoho" data-toggle="modal" data-target="#zohomodal" />
    </h2>
</div>
@stop
            ...
            <div class="modal-body " style="font-size:15px">
                ...
                <div class="tab-content" id="myTabContent">
                                ...
                                <div class="col-6" id="order_id">
                                    <div class="form-group">
                                        ...
                                        <div class="autocomplete" style="width:470px;">
                                            <textarea name="order_ids" rows="5" placeholder="Add order id's here..." id="" type=" text" autocomplete="off" class="form-control up_asin_sync"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                        ...
                        <form class="" id="multi-file-upload" method="POST" action="{{route('orders.zoho.sync')}}" accept-charset="utf-8" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
