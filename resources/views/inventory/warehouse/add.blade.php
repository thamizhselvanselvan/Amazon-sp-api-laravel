    ...
    <div class="col-6">
        ...
        <form action="{{ route('warehouses.store') }}" method="POST" id="admin_user">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-6">
                    <x-adminlte-input label="Address 1" name="address_1" type="text" placeholder="Address 1" value="{{ old('address_1') }}" />
                </div>
                <div class="col-6">
                    <x-adminlte-input label="Address 2" name="address_2" type="text" placeholder="Address 2" value="{{ old('address_2') }}" />
                </div>
                <div class="col-6">
            ...
            <div class="row justify-content-left">
                <div class="col-6">
                    <x-adminlte-input label="Pin Code" name="pin_code" type="text" placeholder="Pin Code" value="{{ old('pin_code') }}" />
                </div>
            </div>

            <div class="row justify-content-center">
                <div class="col-6">
                    <x-adminlte-input label="Contact person name" name="contact_person_name" type="text" placeholder="Person" value="{{ old('contact_person_name') }}" />
                </div>
                <div class="col-6">
                    <x-adminlte-input label="Phone No" name="phone_number" type="text" placeholder="Phone No" value="{{ old('phone_number') }}" />
                </div>
            </div>
            <div class="row justify-content-left">
                <div class="col-6">
                    <x-adminlte-input label="Email" name="email" type="text" placeholder="Email" value="{{ old('email') }}" />
                </div>
            </div>
