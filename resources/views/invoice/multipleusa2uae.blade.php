...
@section('content_header')
    <div class="invoice-company text-inverse f-w-600">
        <span class="pull-right hidden-print">
            <a href="javascript:;" onclick="window.print()" class="btn btn-sm btn-white m-b-10 p-l-5 bg-primary"><i
                    ...
                    <div class="invoice-content">
                                    ...
                                    @foreach ($value['product_details'] as $key1 => $data)
                                        <tr>
                                            ...
                                            @if ($data['product_price'] == '')
                                                <td class="text-center">{{ 0 }}</td>
                                            @else
                                                <td class="text-center">{{ $data['currency'] }}
                                            ...
                                            @if ($data['grand_total'] == '')
                                                <td class="text-center">{{ 0 }}</td>
                                            @else
                                                <td class="text-center">{{ $data['currency'] }} {{ $data['grand_total'] }}
                                                </td>
                                            @endif
                        ...
                        <div class="invoice-price">
                            ...
                            <div class="invoice-price-right">
                                ...
                                @else
                                    <small><b>GRAND TOTAL</b></small> <span class="f-w-600">{{ $data['currency'] }}
                                        {{ $value['grand_total'] }}</span>
                                @endif

                            </div>
                        </div>
                        <!-- end invoice-price -->
                        <p class=" mb-0 text-center">This is system generated invoice, it may contain only digital
                            signature.</p><br><br>

                        <!-- <div class="container"> -->
                        <hr class="dashed"><br><br>
                        <div class="row">
                            <div class="col "><img src="{{ URL::asset('/image/bombinoImage.jpg') }}"
                                    class="img-fluid rounded mx-auto d-block" alt="Bombino_express"></div>
                            ...
                            <tbody>
                                <div class="row">
                                    <div class="col ">
                                        ...
                                        <p class=" ml-2 mt-2"><b> {{ $value['store_name'] }} </b><br>
                                            {{ $value['store_add'] }} </p>
                                    </div>
                                    <div class="col ">
                                        <b class="bg-dark text-white mt-4 ml-2 consignee"> CONSIGNEE </b>
                                        <p class=" ml-2 mt-2"><b> {{ $value['ship_to_name'] }} </b><br>
                                            {{ $value['ship_to_add'] }} </p>
                                    </div>
                                </div>
                            </tbody>
                        ...
                        <table class="table table-bordered table-bordered-dark alpha-table table-sm ">
                            <tbody>
                                <tr>
                                    <td>
                                        <h6 class=" ml-1"><strong>TERMS AND CONDITIONS</strong></h6>
                                        <p>
                                        <table>
                                            <tbody>
                                                <tr>
