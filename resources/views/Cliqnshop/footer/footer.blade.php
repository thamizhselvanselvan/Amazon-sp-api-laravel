...
<div class="row">
    ...
    <div class="col text-center">
        <h3>Cliqnshop Footer Section</h3>
    </div>
</div>
...
<form action="/cliqnshop/footercontent" method="POST">
    ...
    <center>
        <div class="form-group w-25">
            <x-adminlte-select name="site" id="" label="Select Site" >
                <option value="" selected>Select Site</option>
                <option value="in">India</option>
                <option value="uae">UAE</option>
            </x-adminlte-select>
            <x-adminlte-select name="section" id="" label="Select Section">
            ...
            <div>
                <x-adminlte-input label="Enter Content" name="content" id="" type="text" placeholder="Enter Content" />
            </div>
