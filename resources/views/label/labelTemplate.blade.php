                                ...
                                <td>
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">{!! $bar_code !!} <b> {{ $result->awb_no }} </b></div>
                                            <div class="col-md-4"></div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h6>
                                                    <b>SHIP TO </b><br>
                                                    @foreach ($result->shipping_address as $details)
                                                    {{$details}},
                                                    @endforeach
                                                </h6>
                                                <br>
                                            ...
                                            <div class="col-md-6">
                                                <div class=" text-inverse m-b-5 text-left"><strong> Invoice No: </strong>{{$result->order_no}} </div>
                                                <div class=" text-inverse m-b-5 text-left"><strong>
                                                        Order Date: </strong>{{$result->purchase_date}} </div>
                                                <div class=" text-inverse m-b-5 text-left"><strong> INVOICE DATE: </strong>{{$result->purchase_date}}</div>
                                                <div class=" text-inverse m-b-5 text-left"><strong> Pieces: </strong> {{$result->order_item}} </div>
                                                <div class=" text-inverse m-b-5 text-left"><strong>
