...
<div class="invoice-company text-inverse f-w-600">
    <span class="pull-right hidden-print">
        <a href="javascript:void();" class="btn btn-sm btn-white m-b-10 p-l-5" id="Export_to_pdf"><i class="fa fa-file t-plus-1 text-danger fa-fw fa-lg"></i> Export as PDF</a>
                            ...
                            <tbody >
                                ...
                                <tr>
                                    <td>
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-4"><h4><strong> Tracking Details : </strong></h4></div>
                                                <div class="col-md-4"></div>
                                                <div class="col-md-4"> <h4 class="text-right"><strong>SMSA/{{ $result->awb_no }}</strong></h4></div>
                                            </div>
                                        </div>
                                    </td> 
                                </tr>
