...
@section('content')
    ...
    <div class="row ">
        <div class="col search_by_order_id">
            ...
            <textarea class="form-control search_id" rows="4" placeholder="Eg:- Amazon Order Id: 333-7777777-7777777"
                name="order_id" id='order_id'></textarea>
        ...
        <div class="col search_by_tracking_id d-none">
            <label> AWB No.</label>
            <textarea class="form-control search_id" rows="4" placeholder="Enter Awb No." name="awb_no"
                id='awb_tracking_id'></textarea>
            <div class="text-right m-2">
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, result) {
                            ...
                            record_of_awb_id += "<tr><td>" + result['store_name'] +
                                ...
                                "</td><td><a href='/label/pdf-template/orderid-" + result[
                                'id'] +
                                "' class='btn-sm btn-success' target='_blank'><i class='fas fa-eye'></i>View</a><a href='/label/download-direct/orderid-" +
                                result['id'] +
                                "' class='btn-sm btn-info ml-1'><i class='fas fa-download'></i>Download</a> <a href='javascript:void(0)'" +
                                " data-order_item_identifier=" + result[
