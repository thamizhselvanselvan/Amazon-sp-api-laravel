    ...
    <div class="col">
        ...
        <h2 class="row mb-4 ">
            ...
            <div class="col-3 align-self-end progress_bar">
                <x-adminlte-progress class='border border-success' id="progresBar" theme="pink" value="0" animated
                    with-label />
            </div>
        </h2>
        <!-- Header Modal -->
        <div class="modal fade" id="productExport" tabindex="-1" role="dialog" aria-labelledby="productExportModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body " id="checkboxlist">
                        ...
                        <div class="form-check d-flex row">
                            ...
                            <div class="col-2">
                                <input class="form-check-input header_options" type="checkbox" value="shipping_weight"
                                    name='options[]' id="shipping_weight">
                        ...
                        <div class="form-check d-flex row">
                            ...
                            <div class="col-2">
                                <input class="form-check-input header_options" type="checkbox" value="detail_page_url"
                                    name='options[]' id="detail_page_url">
        ...
        <!-- End of Header Modal -->
        <!-- Download Modal -->
        <div class="modal fade" id="file_download_modal" tabindex="-1" role="dialog" aria-labelledby="FileDownloadModal"
            aria-hidden="true">
