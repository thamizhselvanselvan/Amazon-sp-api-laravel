...
<div class="row">
    ...
    <div class="col text-right">
        ...
        <x-adminlte-button label="Download" theme="primary" class="btn-sm" icon="fas fa-download" id="catalogdownload" data-toggle="modal" data-target="#downloadModal" />
...
<div class="row">
    ...
    <div class="col-8 ">
        <div class="card ">
            ...
            <div class="card-body ">
                <div class="text-area">
                    <form action="{{ route('catalog.with.price.export') }} " method="POST" enctype="multipart/form-data">
                        @csrf
                        <label for="Select Source" class="mt-0">Select Source</label><br>
                        <div class="row ">
                            <div class="col-1">
                                <input type="radio" class="catalog-with-price" name="source" value="IN" id="IN" />
                                <label for="IN">IN</label>
                            </div>
                            <div class="col-1">
                                <input type="radio" class="catalog-with-price" name="source" value="US" id="US" />
                        ...
                        <div class=" select_header d-none">
                            ...
                            <div class="mt-1 row ">
                                ...
                                <div class="col-2 catalog">
                                    <input class="choose_header" type="checkbox" value="cat.asin" name='header[]' id="asin">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-2 india_price d-none">
                                    <input class="choose_header" type="checkbox" value="pricing_ins.weight" name='header[]' id="weight">
                                    <label class="ml-1" for="Weight">Weight</label>
                                </div>

                                <div class="col-2 usa_price d-none">
                                    <input class="choose_header" type="checkbox" value="pricing_uss.weight" name='header[]' id="weight">
                                    <label class="ml-1" for="Weight">Weight</label>
                                </div>
                        ...
                        <x-adminlte-textarea label="Enter ASIN" name="text_area_asins" type="text" rows="8" placeholder="Enter ASIN" />
                        <input type='hidden' name='form_type' value='text-area' id='text_area_upload' />
                        <x-adminlte-button label='Export' type='submit' theme='success' icon='fas fa-file-export' class=" btn-sm float-right mt-2 " />
                ...
                <div class="file-upload d-none">
                    <form action="{{ route('catalog.with.price.export') }} " method="POST" enctype="multipart/form-data">
                        ...
                        <x-adminlte-button label='Export' type='submit' theme='success' icon='fas fa-file-export' class=" btn-sm float-right mt-2 " id="catalogwithprice" />
