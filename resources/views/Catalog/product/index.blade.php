                    ...
                    <div class="modal-body" style="font-size:15px">
                        <form action="{{ route('catalog.export') }}">
                            ...
                            <div class="col-12 float-left mt-2">
                                <x-adminlte-button label="Export" theme="success" class="btn btn-sm " icon="fas fa-file-export " type="submit" id="catalog_export" />
                            </div>
                        </form>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-3 float-left mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control float-right datepicker" name='export_date' placeholder="Select Date Range" autocomplete="off" id="export_date">
                                        ...
                                        <div class="col-2 float-left mt-2">
                                            <div style="margin-top: 2.1rem;">
                                                <x-adminlte-button label="Export" theme="success" id='ok' class="btn btn-sm " icon="fas fa-file-export " type="submit" id="catalogPriceExportButton" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                <form action="{{ route('catalog.export.all-price') }}" method="POST">
                                    ...
                                    <div class="row border">
                                        <div class="col-2">
                                            <label for="IN">IN</label>
                                            <input type="radio" name="source" class='Asin-source' value="IN" id="IN">
                                        </div>
                                        <div class="col-2">
                                            <label for="US">US</label>
                                    ...
                                    <div class="col text-right">
                                        <x-adminlte-button label="Export" theme="success" class="btn btn-sm export_btn" icon="fas fa-file-export " type="submit" id="allPriceExportButton" />
                                    </div>
                                </form>
                            </div>
