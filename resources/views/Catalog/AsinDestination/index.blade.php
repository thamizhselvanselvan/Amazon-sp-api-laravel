    ...
    <div class="row">
        ...
        <div class="col ">
            ...
            <h2 class="mb-4 float-right">
                ...
                <div class="modal fade" id="destinationTruncate" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-body" style="font-size:15px">
                                <form action="{{ route('catalog.asin.destination.truncate') }}">
                                    ...
                                    <div class="col-12 float-left mt-2">
                                        <x-adminlte-button label="Truncate" theme="danger" class="btn btn-sm truncate"
            ...
            <form action=" {{ route('catalog.asin.destination.search.delete') }} " method="POST">
                ...
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <x-adminlte-button label="Search & Delete" type="submit" theme="primary"
                            icon="fas fa-trash text-danger" class="search&delete btn-sm float-right mt-2 "
                            onclick="return confirm('Are you sure you want to delete these asins?')" />
                    </div>
                </div>
            </form>
        </div>
