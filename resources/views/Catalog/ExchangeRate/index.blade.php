            ...
            <form action="{{ route('catalog.update.exchange.rate') }}" method="post">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <x-adminlte-select label="Choose Source-Destination" name="source_destination"
                    ...
                    <div class="col">
                        <x-adminlte-input label="Packaging" type="text" name="packaging" placeholder="Packaging"
                            class="packaging" />
                    </div>

                    <div class="col">
                        <x-adminlte-input label="Selling Price Commission" type="text" name="sp_commission"
                            placeholder="Selling Price Commission" class="sp_commission" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <x-adminlte-input label="Seller Commission" type="text" name="seller_commission"
                            placeholder="Seller Commission" class="seller_commission" />
                    </div>

                    <div class="col">
                        <x-adminlte-input label="Excerise Rate" type="text" name="excerise_rate"
                            placeholder="Excerise Rate" class="excerise_rate" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <x-adminlte-input label="Base Shipping Charge" type="text" name="base_shipping_charge"
                            placeholder="Base Shipping Charge" class="base_shipping_charge" />
                    </div>

                    <div class="col">
                        <x-adminlte-input label="Duty Rate" type="text" name="duty_rate" placeholder="Duty Rate"
                            class="duty_rate" />
                    </div>

                    <div class="col">
                        <x-adminlte-input label="Amazon Commission" type="text" name="amazon_commission"
                            placeholder="Amazon Commission" class="amazon_commission" />
                    </div>
                </div>
                <p class="text-center">
        ...
        $(document).ready(function() {
            ...
            $('.source_destination').change(function(event) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('catalog.record.auto.load') }}",
                    method: "GET",
                    data: {
                        "option": option,
                        "_token": "{{ csrf_token() }}",
                    ...
                    success: function(response) {
                        $.each(response, function(key, result) {
                            ...
                            $('.base_shipping_charge').val(result[
