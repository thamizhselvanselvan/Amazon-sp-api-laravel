...
<div class="row">
    <div class="col">
        <a href="/admin/geo/city" class="btn btn-primary">
...
<div class = "ml-5 mr-5 p-2 bg-gradient-light text-white rounded">
  ...
  <option value="{{$state1->id}}" {{$state1->id == $cities->state_id ? 'selected' : '' }}>{{$state1->name}}</option>
  @endforeach
</select>
<br>
    <input type="text" class="form-control w-25 m-auto" id="city" name ="city_name" placeholder ="City" value= {{$cities->name}} autofocus required autocomplete="off">
