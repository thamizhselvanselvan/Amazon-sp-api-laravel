...
@section('content_header')
    ...
    <div class="row">
        <div class="col">
            <a href="{{ route('geo.state.index') }}" class="btn btn-primary">
    ...
    <div class="ml-5 mr-5 p-2 bg-gradient-light text-white rounded">
        <form class="text-center" method="POST" action="/update_state/{{ $states->id }}">
            ...
            <div class="m-2">
                ...
                <br>
                <input type="text" class="form-control w-25 m-auto" id="state" name="state_name"
                    value={{ $states->name }} placeholder="State" autofocus required autocomplete="off">
