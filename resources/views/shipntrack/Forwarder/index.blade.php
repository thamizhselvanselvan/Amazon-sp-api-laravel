            ...
            <div class="card">
                ...
                <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                    <div class="card-body py-1">
                        <x-adminlte-input label="AWB No :" name="awb" type="text" id="system_gen" placeholder="System Generated" />
                        ...
                        <x-adminlte-input label="Reference ID:" name="reference_id" type="text" placeholder="RefrenceID..." value="{{ old('reference_id') }}" required />
                    ...
                    <div class="">
                        ...
                        <div id="collapseTwo" class="collapse show" data-bs-parent="#accordion">
                            <div class="card-body py-1">
                                <x-adminlte-input label="Consignor :" name="cnr_consignor" type="text" placeholder="Consignor" value="{{ old('cnr_consignor') }}" autocomplete="off" required />
                                <x-adminlte-input label="CPerson :" name="cnr_cperson" type="text" placeholder="Contact Person" value="{{ old('cnr_cperson') }}" autocomplete="off" />
                                <x-adminlte-input label="Address1 :" name="cnr_address1" type="text" placeholder="Enter Address1" value="{{ old('cnr_address1') }}" autocomplete="off" required />
                                <x-adminlte-input label="Address2 :" name="cnr_address2" type="text" placeholder="Enter Address2" value="{{ old('cnr_address2') }}" autocomplete="off" required />
                                <x-adminlte-input label="Pin Code :" name="cnr_pincode" type="text" placeholder="Enter Pin Code" value="{{ old('cnr_pincode') }}" autocomplete="off" required />
                                <x-adminlte-input label="Country :" name="cnr_country" type="text" placeholder="Enter Country" value="{{ old('cnr_country') }}" autocomplete="off" required />
                                <x-adminlte-input label="State :  " name="cnr_state" type="text" placeholder="Enter State" value="{{ old('cnr_state') }}" autocomplete="off" required />
                                <x-adminlte-input label="City :" name="cnr_city" type="text" placeholder="Enter City" value="{{ old('cnr_city') }}" autocomplete="off" required />
                                <x-adminlte-input label="Mobile No :" name="cnr_mobile_no" type="text" placeholder="Enter Mobile No" value="{{ old('cnr_mobile_no') }}" autocomplete="off" required />
                            </div>
                        </div>
                    </div>
                    <div class="">
