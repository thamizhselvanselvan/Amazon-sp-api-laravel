...
<form action="{{ Route('shipntrack.forwarder.store.forwarder') }}" method="post" id="admin_user">
    ...
    <div class="align">
        ...
        <div>
            <x-adminlte-input label="Consignor :" name="consignor" type="text" placeholder="Consignor" value="{{ old('consignor') }}" autocomplete="off" />
        </div>
        <div>
        ...
        <div>
            <x-adminlte-input label="Forwarder 1 AWB :" name="forwarder_1_awb" type="text" placeholder="Forwarder 1 AWB " value="{{ old('forwarder_1_awb') }}" autocomplete="off" />
        </div>
        <div>
