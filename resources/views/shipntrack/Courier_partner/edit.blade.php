                    ...
                    <div class="col-6">
                        ...
                        <x-adminlte-select name="source" label="Select Source:" id="source">
                            <option value="{{ $data->source ?? '' ? $data->source : '' }}">
                                {{ $data->source ?? '' ? $data->source : 'Select Source' }} </option>
                    ...
                    <div class="col-6">
                        ...
                        <x-adminlte-select name="destination" label="Select Destination:" id="destination">
                            <option value="{{ $data->destination ?? '' ? $data->destination : '' }}">
                                {{ $data->destination ?? '' ? $data->destination : 'Select destination' }} </option>
                            <option value="IN">IN</option>
                            <option value="USA">USA</option>
                            <option value="AE">AE</option>
                            <option value="KSA">KSA</option>
                ...
                <div class="row justify-content-left">
                    <div class="col-6">
                        ...
                        <x-adminlte-select name="time_zone" label="Select Time Zone:" id="time_zone">
                            <option value="{{ $data->time_zone ?? '' ? $data->time_zone : '' }}">
                                {{ $data->time_zone ?? '' ? $data->time_zone : 'Select TimeZone' }} </option>
                    ...
                    <div class="col-6">
                        <x-adminlte-input label="User ID:" name="user_id" type="text" i="user_id"
                            placeholder="User ID" value="{{ $data->user_id }}" autocomplete="off" />
                    </div>

                    <div class="col-6">
                        <x-adminlte-input label="Password:" name="password" type="text" id="Password"
                            placeholder=" Password" value="{{ $data->password }}" autocomplete="off" />
                    </div>

                    <div class="col-6">
                        <x-adminlte-input label="Account ID:" name="account_id" id="account_id" type="text"
                            placeholder="Accound ID" value="{{ $data->account_id }}" autocomplete="off" />
                    </div>

                    <div class="col-6">
                        <x-adminlte-input label="Key1:" name="key1" type="text" placeholder="Key1"
                            value="{{ $data->key1 }}" autocomplete="off" />
                    </div>

                    <div class="col-6">
                        <x-adminlte-input label="Key2:" name="key2" type="text" placeholder="Key2"
                            value="{{ $data->key2 }}" autocomplete="off" />
                    </div>
                </div>
