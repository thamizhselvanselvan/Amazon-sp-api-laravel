...
@section('title', 'Add Bombino AWB No.')

@section('content_header')
<div class="row">
    <h1 class="m-0 text-dark col">Upload AWB No.</h1>
    <h2 class="mb-4 text-right col">
        <a href="{{route('shipntrack.bombino')}}">
...
<div class="row m-3 ">
    <div class="col-12 text-box-input">
        <form class="row" action="{{Route('shipntrack.bombino.gettracking')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <label>Enter AWB No.</label>
            <textarea class="form-control" rows="3" placeholder="Tracking Number" name="bombino_awbNo"></textarea>
