...
return [
    ...
    */
    ...
    'environments' => [
        'production' => [
            'ca-supervisor-1' => ['connection' => 'redis', 'queue' => ['catalog'], 'balance' => 'auto', 'minProcesses' => 1, 'maxProcesses' => 5, 'tries' => 3, 'balanceMaxShift' => 5, 'balanceCooldown' => 1],
            ...
            'ca-supervisor-9' => ['connection' => 'redis', 'queue' => ['csv_import'], 'balance' => 'auto', 'minProcesses' => 1, 'maxProcesses' => 1, 'tries' => 3, 'balanceMaxShift' => 5, 'balanceCooldown' => 1],
        ],
        'staging' => [
