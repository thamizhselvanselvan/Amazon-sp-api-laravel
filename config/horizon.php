...
return [
    ...
    */
    ...
    'environments' => [
        'production' => [
            'ca-supervisor-1' => ['connection' => 'redis', 'queue' => ['order'], 'balance' => 'auto', 'minProcesses' => 1, 'maxProcesses' => 3, 'tries' => 3, 'balanceMaxShift' => 5, 'balanceCooldown' => 1],
            ...
            'ca-supervisor-4' => ['connection' => 'redis', 'queue' => ['amazonInvoice'], 'balance' => 'auto', 'minProcesses' => 1, 'maxProcesses' => 1, 'tries' => 3, 'balanceMaxShift' => 5, 'balanceCooldown' => 1],
        ],
        'staging' => [
